...
<link rel="stylesheet" href="{{ asset('public/components/angular-material/angular-material.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('public/components/font-awesome/css/font-awesome.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/frontend/style.css') }}">